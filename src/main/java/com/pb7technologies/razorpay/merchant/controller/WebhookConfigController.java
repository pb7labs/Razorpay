package com.pb7technologies.razorpay.merchant.controller;
...
import com.pb7technologies.razorpay.merchant.service.WebhookConfigService;
...
public class WebhookConfigController {
    ...
    @PostMapping
    private ResponseEntity<WebhookConfigResponse> create(@Valid @RequestBody UpdateWebhookConfigRequest request) {
