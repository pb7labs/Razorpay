package com.pb7technologies.razorpay.vault.dto.request;

import com.pb7technologies.razorpay.vault.validatiion.ExpiryYear;
...
public record TokenizeRequest(
        ...
        @Size(min = 3, message = "Card Holder name should at least 3 Characters")
